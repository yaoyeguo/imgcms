...
(1, 'admin', '21274ecc6de888982e665bf661cb5b07', '', 15);

INSERT INTO `#@_adsense` (`id`, `title`, `des`, `content`) VALUES
(1, 'banner', '头部banner广告', '<a href="http://www.imgcms.com" target="_blank"><img src="{$web_url}/images/ad/adv_700_90.jpg" border="0" /></a>'),
(2, 'index-top', '首页上部广告', '<a href="http://www.imgcms.com" target="_blank"> <img border="0" src="{$web_url}/images/ad/adv_980_90.jpg" width="980" height="90"> </a>'),
(3, 'index-bottom', '首页底部广告', '<a href="http://www.imgcms.com" target="_blank"> <img border="0" src="{$web_url}/images/ad/adv_980_90.jpg" width="980" height="90"> </a>'),
(4, 'article-right', '内容页右边广告', '<a href="http://www.imgcms.com"><img src="{$web_path}/images/ad/adv_300_200.jpg" alt="" /></a>'),
(6, 'cate-right', '列表页右边广告', '<a href="http://www.imgcms.com"><img src="{$web_path}/images/ad/adv_220_90.jpg" alt="" /></a>');
...
('web_name', 'IMGCMS图片网站管理程序', ''),
('admin_name', 'IMGCMS团队', ''),
('web_url', 'http://localhost/imgcms/', ''),
('web_path', '/imgcms/', ''),
('web_email', '1216560669@qq.com', ''),
('web_qq', '1216560669', ''),
('web_icp', '京ICP10000001号', ''),
('web_hotkey', 'IMGCMS|IMGCMS图片管理程序', ''),
('web_keywords', 'IMGCMS|IMGCMS图片管理程序', ''),
('web_description', 'IMGCMS|IMGCMS图片管理程序', ''),
('web_copyright', 'Copyright © 2008-2016 <strong style="color:#FF6600">ImgCMS.Inc</strong>, All Rights Reserved IMGCMS·Team 版权所有', ''),
('led_values', 'IMGCMS-LED展示效果-请去后台编辑文本内容跟链接网址', ''),
('led_ok', '1', ''),
('led_link', 'http://www.imgcms.com', ''),
('web_tongji', '', ''),
('upload_http_thumb', '0', ''),
...
('upload_dispatch', '1', ''),
('upload_safe_link', '0', ''),
('upload_safe_domain', 'img.com|imgcms.com', ''),
('upload_ftp', '0', ''),
('upload_ftp_host', '', ''),
('upload_ftp_user', '', ''),
('upload_ftp_pass', '', ''),
...
('url_route', '0', ''),
('upload_water_text', 'IMGCMS·Team-技术支持', ''),
('upload_water_textcolor', 'ffffff', ''),
('upload_water_bgcolor', '000000', '');


INSERT INTO `#@_lang_chs` (`name`, `value`) VALUES
('cms_name', 'IMGCMS图片管理系统'),
('cms_ver', 'V1.6');

INSERT INTO `#@_link` (`id`, `title`, `logo`, `url`, `oid`, `type`) VALUES
(1, 'IMGCMS官网', '', 'http://www.imgcms.com', 0, 1),
(2, '百度', '', 'http://www.baidu.com', 2, 1),
(3, '新浪', '', 'http://www.sina.com.cn', 3, 1),
(4, '腾讯', '', 'http://www.qq.com', 4, 1);
