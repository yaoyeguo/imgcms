...
<table cellpadding="1" cellspacing="5" id="container">
  ...
  <tr>
    <td class="bodytext">The program has encountered a problem. <a target="_blank" href="<?php echo Wee::$config['sys_url']?>"><span class="red">Need Help?</span></a></td>
  </tr>
  <tr>
    <td><hr size="1"/></td>
  </tr>
  ...
  <tr>
    <td class="help"><br />
      <br />
      请与 <a href="<?php echo Wee::$config['sys_url']?>"><?php echo Wee::$config['sys_name']?></a><sup><?php echo Wee::$config['sys_ver'];?></sup></a> 管理员联系, 由此给您带来的访问不便我们深感歉意</td>
  </tr>
</table>
</body>
</html>